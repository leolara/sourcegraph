...
var tlsExternal = conf.Cached(func() any {
	...
	logger := log.Scoped("experimental", "Experimental features").Scoped("tls-external", "Global TLS/SSL settings for Sourcegraph to use when communicating with code hosts.")
